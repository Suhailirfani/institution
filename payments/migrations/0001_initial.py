    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TUITION', 'Tuition Fee'), ('EXAM', 'Exam Fee'), ('HOSTEL', 'Hostel Fee'), ('DONATION', 'Donation')], max_length=20)),
                ...
                ('student', models.ForeignKey(blank=True, help_text='Linked student, if applicable.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='payments', to='academics.studentprofile')),
